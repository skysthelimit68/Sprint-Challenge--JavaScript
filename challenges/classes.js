...
function CuboidMaker(arr) {
  ...
  */
  ...
  const _cuboid = new _CuboidMaker({
    length: 4,
    width: 5,
    height: 5
  });
...
class _CubeMaker extends _CuboidMaker {
    constructor(att){
        super(att);
    }
    volume() {
...
const _cube = new _CubeMaker({
    length: 5
  });

  console.log(_cube.volume()); // 125
  console.log(_cube.surfaceArea()); // 150