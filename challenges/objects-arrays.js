...
function createDino (att) {
  this.name = att.name;
  this.diet = att.diet;
  this.weight = att.weight;
  this.length = att.length;
  this.timePeriod = att.timePeriod;
}

const tyrannosaurus = new createDino ({
  name : "Tyrannosaurus",
  diet : "carnivorous",
  weight : "7000kg",
  length : "12m",
...
const stegosaurus = new createDino ({
  name : "Stegosaurus",
  diet : "herbivorous",
  weight : "2000kg",
  length : "9m",
...
const velociraptor = new createDino ({
  name : "Relociraptor",
  diet : "carnivorous",
  weight : "15kg",
  length : "1.8m",
...
*/
const largerPopulation = zooAnimals.filter(elem => elem.population < 5);
...
*/
const populations = zooAnimals.map(elem => elem.population);
const populationTotal = populations.reduce((acc, elem) => acc + elem);
